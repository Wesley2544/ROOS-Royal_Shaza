...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M6 2h12l1 5H5l1-5Z"/><path d="M4 7h16l-1.4 12.6a2 2 0 0 1-2 1.4H7.4a2 2 0 0 1-2-1.4L4 7Z"/><path d="M9 11v4M15 11v4"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 3v18h18"/><path d="M18.7 8 13 13.7l-3-3L7 13.5"/>
      </svg>
    ),
  },
  {
...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex">
      ...
      <aside className="w-44 bg-white border-r border-[#E5E5E5] flex-shrink-0 min-h-screen flex flex-col">
        <div className="px-4 py-4 border-b border-[#E5E5E5]">
          <div className="text-sm font-extrabold text-[#0A0A0A]">Royal Shaza Suites</div>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-4 py-2.5 text-sm transition-colors text-left
                  ${active
                    ? 'bg-[#F4F4F5] text-[#0A0A0A] font-bold border-r-[3px] border-[#FDC700]'
                    : 'text-gray-500 hover:bg-[#F5F5F5]'
                  }`}
              >
                <span className={active ? 'text-[#0A0A0A]' : 'text-gray-400'}>{item.icon}</span>
